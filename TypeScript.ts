...
const numeroString: string | null = prompt("Introduce el número:");

if (numeroString !== null) {
    const numero: number = parseInt(numeroString);
...
}else {console.log("Entrada no válida. Introduce un número.");}
...
let cadena: string = "";
let edadString: string | null = prompt("Introduce edad:");

if (edadString !== null) {

    const edad: number = parseInt(edadString);
